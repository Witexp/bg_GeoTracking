...
public class Config implements Parcelable
{
    ...
    private String httpTemplateRoot;
    ...
    public Config(Config config) {
        ...
        this.httpTemplateRoot = config.httpTemplateRoot;
    ...
    private Config(Parcel in) {
        ...
        setHttpTemplateRoot(in.readString());
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeString(getHttpTemplateRoot());
    ...
    public String getHttpTemplateRoot() {
        return httpTemplateRoot;
    }

    public void setHttpTemplateRoot(String httpTemplateRoot) {
        this.httpTemplateRoot = httpTemplateRoot;
    }

    public boolean hasHttpTemplateRoot() {
        return httpTemplateRoot != null;
    }
    ...
    public String toString () {
        return new StringBuffer()
                ...
                .append(" httpTemplateRoot=").append(getHttpTemplateRoot())
    ...
    public static Config merge(Config config1, Config config2) {
        ...
        if (config2.hasHttpTemplateRoot()) {
            merger.setHttpTemplateRoot(config2.getHttpTemplateRoot());
        }
