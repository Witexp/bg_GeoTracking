...
public class BatchManager {
    ...
    private File createBatchFromTemplate(Long batchStartMillis, Integer syncThreshold, LocationTemplate template, String httpRoot) throws IOException {
        logger.info("Creating batch {}", batchStartMillis);
    ...
    public File createBatch(Long batchStartMillis, Integer syncThreshold, LocationTemplate template, String httpRoot) throws IOException {
        LocationTemplate tpl;
        if (template != null) {
            tpl = template;
        } else {
        ...
        return createBatchFromTemplate(batchStartMillis, syncThreshold, tpl, httpRoot);
    }
    ...
    private static class LocationWriter {
        ...
        public void newValue(String value) throws  IOException {
            writer.value((String) value);
        }
