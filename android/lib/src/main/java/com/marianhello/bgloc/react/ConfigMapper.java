...
public class ConfigMapper {
    public static Config fromMap(ReadableMap options) throws JSONException {
        ...
        if (options.hasKey("httpTemplateRoot")) config.setHttpTemplateRoot(
                !options.isNull("httpTemplateRoot") ? options.getString("httpTemplateRoot") : Config.NullString
        );
    ...
    public static ReadableMap toMap(Config config) {
        ...
        if (config.getHttpTemplateRoot() != null) {
            if (config.getHttpTemplateRoot() != Config.NullString) {
                out.putString("httpTemplateRoot", config.getHttpTemplateRoot());
            } else {
                out.putNull("httpTemplateRoot");
            }
        }
